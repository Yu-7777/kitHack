...
print((scaler.inverse_transform(X.reshape(-1, 1)).reshape(-1, sequence_length, 1)).shape)
print(scaler.inverse_transform(y[-1].reshape(-1, 1)).reshape(-1, sequence_length, 1))
